...
public class GenerateAst {
    static final String OUTPUT_DIR = "../lou-core/src/main/java/com/ab/lou";
    ...
    public static void main(String[] args) throws IOException {
        ...
        defineAst("Stmt",
                Arrays.asList("Block: List<Stmt> statements", "Break: Token keyword",
    ...
    private static void defineAst(String baseName, List<String> types) throws IOException {
        String path = Paths.get(OUTPUT_DIR, baseName) + ".java";
        PrintWriter writer = new PrintWriter(path, "UTF-8");

        writer.println("package " + OUTPUT_PACKAGE + ";");
        writer.println();
